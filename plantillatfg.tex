...
\subsection{Estudi del mercat de les xarxes socials}
...
\subsection{Estudi del mercat d’aplicacions per a persones amb diversitat funcional de dèficit cognitiu}
...
\section{Conclusions de l’estudi de mercat}
...
\chapter{Formulació del problema}
...
\chapter{Metodología i rigor}

\section{Metodologies de treball} 
...
\section{Planificació general}

\subsection{Durada estimada del projecte}
...
\subsection{Pla d’acció i valoració d’alternatives}
...
\subsection{Consideracions globals}
...
\subsection{Gestió del Projecte (GEP)}
...
\subsection{Desenvolupament de la xarxa social}
...
\subsection{Desenvolupament de l’eina de gestió}
...
\subsection{Documentació i Defensa}
